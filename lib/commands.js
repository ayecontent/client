...
//          fs.writeFile(path.resolve(clientOptions.sourceFolder, '.gitignore'), clientOptions.stopContentDeliveryFile + '\n' + clientOptions.stopPeriodicRsyncFile + '\n' + clientOptions.startContentDeliveryFile + '\n');
