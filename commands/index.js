...
exports.GitSyncCommand = _.partial(exports.Command, require('./gitsync').gitSync);
util.inherits(exports.GitSyncCommand, exports.Command);

exports.LocalSyncCommand = _.partial(exports.Command, require('./localsync').localSync);
